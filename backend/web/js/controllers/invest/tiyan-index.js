...
app.controller('indexlisttiyanMenuCtrl',['$scope', 'gridSharedService','$http', '$state', function($scope, gridSharedService, $http, $state){
    //编辑按钮组
    $scope.editGroup = {
        btnNew: true,
        btnEdit: false,
    ...
    $scope.openlistEditor = function(action){
        ...
        if(list){
            $state.go("app.invest_list_view",{id:list.invest_id});
        }else{
...
app.controller('indextiyanCtrl', ['$scope', '$http','gridSharedService','$state','$filter', function($scope, $http,gridSharedService,$state, $filter) {
    ...
    $scope.getPagedDataAsync = function (pageSize, page, searchText) {
        setTimeout(function () {
            ...
            if (searchText) {
                ...
                $http.get('invest/list/tiyan-index').success(function (largeLoad) {
