...
angular.module('app')
    .controller('AppCtrl', ['$scope', '$http', '$translate', '$localStorage', '$window',
        function ($scope, $http, $translate, $localStorage, $window) {
            ...
            $http.post('auth/get-user-info', {}).success(function (data) {
                $scope.userInfo = data;
            });
        }]);


angular.module('app').run(function ($http, $state) {
    $http.get('auth/check-access', {}).success(function (data) {
        if (data) {
...
app.controller('NavController', function ($scope, $http) {
    $http.get('auth/meun-nav', {}).success(function (data) {
        $scope.navItems = data;
    });
});